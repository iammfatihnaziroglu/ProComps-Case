...
const SectionLabel: React.FC = () => {
  return (
    <div className="shadow-opacity-6 h-[222px] max-w-[560px] gap-[32px] rounded-lg border border-neutrals-300 bg-neutrals-50 p-[32px] shadow md:h-[auto] ">
      <div className="h-[142px] w-[464px] gap-[12px] pb-3 md:h-[auto] md:w-[464px]">
        ...
        <p className="text-neutrals-400 text-w-[500px] mt-4 h-[48px] w-[464px] font-mono text-[40px] font-semibold leading-[32px] tracking-[-0.03em] md:text-[40px] md:leading-[48px]">
          Comps Panel Design
        </p>
        <p className="mt-4 font-mono text-sm text-neutrals-300  md:text-sm">
